...
Route::name('frontend.')->group(function () {
    ...
    Route::post('/fetch/order-rule', [CustomerOrderRuleController::class, 'fetchAvailableRule'])->name('fetch.order-rule');
    Route::post('/fetch/rule', [CustomerOrderRuleController::class, 'fetchRuleField'])->name('fetch.rule-field');
    Route::get('/fetch/contacts/{customer_id}', [CustomerOrderRuleController::class, 'fetchContactsByCustomer'])->name('fetch.contacts');
